                ...
                <div class="card border-0 shadow mb-4 p-3">
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3 class="fs-4 mb-1">User List</h3>
                            </div>
                        </div>
                        @if(session('success'))
                                                ...
                                                <td>
                                                    <div class="action-dots ">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="deleteUser({{ $user->id }})"><i class="fa fa-edit" aria-hidden="true"></i> Delete</a></li>
